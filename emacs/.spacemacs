...
values."
  ...
  (setq-default
   ...
   dotspacemacs-startup-lists '((projects . 15))
   ...
   ;; (default nil)
   dotspacemacs-visual-line-move-text 'notnil
...
`dotspacemacs/user-config' first."
  ...
  (load-file "~/.el/dash.el/dash.el")
  (load-file "~/.el/autothemer/autothemer.el")
